---
layout: post
title:  "Leet787 Cheapest Flights Within K Stops"
date:   2018-05-01 08:00:00
categories:  [Heap, DP, BFS, Medium]
tags: [Airbnb ]
---

<div class="question-description"><div><p>There are <code>n</code> cities connected by&nbsp;<code>m</code> flights. Each fight starts from city&nbsp;<code>u </code>and arrives at&nbsp;<code>v</code> with a price <code>w</code>.</p>
...
Solution 1:
{% highlight c++ %}
{% include leet787/leet787.cpp %}
{% endhighlight %}

Solution 2:
{% highlight c++ %}
{% include leet787/leet787_2.cpp %}
{% endhighlight %}

Solution 3:
{% highlight c++ %}
{% include leet787/leet787_3.cpp %}
{% endhighlight %}
